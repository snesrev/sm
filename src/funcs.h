...
void CalculateCrystalFlashHdmaDataTablesScaled_LeftOfScreen(uint16 k, uint16 j);
void CalculateCrystalFlashHdmaDataTablesScaled_OnScreen(uint16 k, uint16 j);
void CalculateCrystalFlashHdmaDataTablesScaled_RightOfScreen(uint16 k, uint16 j);
