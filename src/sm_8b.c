...
void LoadTitleSequenceGraphics(void) {  // 0x8B9B87
  ...
  DecompressToMem(g_ram + 0x14000);
  mov24(&decompress_src, 0x9580D8);
  DecompressToMem(g_ram + 0x15000);
  mov24(&decompress_src, 0x95A5E1);
  DecompressToMem(g_ram + 0x19000);
  WriteReg(VMADDL, 0);
  WriteReg(VMADDH, 0);
  WriteReg(VMAIN, 0x80);
...
void CinematicFunction_Intro_Initial(void) {  // 0x8BA395
  ...
  DecompressToMem(g_ram + 0x18000);
  mov24(&decompress_src, 0x9788cc);
  DecompressToMem(g_ram + 0x19000);
  mov24(&decompress_src, 0x96ff14);
  DecompressToMem(g_ram + 0x19800);
  mov24(&decompress_src, 0x95e4c2);
  DecompressToMem(g_ram + 0x1b800);
...
void CinematicFunctionEscapeFromCebes(void) {  // 0x8BD480
  ...
  DecompressToMem(g_ram + 0x1e800);
  mov24(&decompress_src, 0x98baed);
  DecompressToMem(g_ram + 0x1f000);
  mov24(&decompress_src, 0x98bccd);
  DecompressToMem(g_ram + 0x1f800);
